...
export { CliService } from "https://raw.githubusercontent.com/drashland/services/v0.2.0/cli/cli_service.ts";
...
import * as colours from "https://deno.land/std@0.91.0/fmt/colors.ts";
export { colours };
