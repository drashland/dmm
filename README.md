...
Information on fmt
  ...
  - deno.land Link: https://deno.land/std@0.73.0/fmt
  - GitHub Repository: https://github.com/denoland/deno/tree/master/std/fmt
  - Import Statement: import * as fmt from "https://deno.land/std@0.73.0/fmt";
...
import * as colors from "https://deno.land/std@0.73.0/fmt/colors.ts"; // up to date
...
$ dmm check
...
drash can be updated from v1.0.0 to v1.2.4
fs can be updated from 0.53.0 to 0.73.0
...
```
...
$ dmm update
...
drash was updated from v1.0.0 to v1.2.4
fs was updated from 0.53.0 to 0.73.0
...
```
...
```typescript
export { Drash } from "https://deno.land/x/drash@v1.2.4/mod.ts"; // was out of date

import * as fs from "https://deno.land/std@0.73.0/fs/mod.ts"; // was out of date

import * as colors from "https://deno.land/std@0.73.0/fmt/colors.ts";
