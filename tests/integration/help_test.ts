...
USAGE
    ...
    deno install --allow-net='x.nest.land,cdn.deno.land,api.deno.land,raw.githubusercontent.com' --allow-read='.' --allow-write='deps.ts' https://deno.land/x/dmm@v1.2.0/mod.ts
    dmm [SUBCOMMAND]
